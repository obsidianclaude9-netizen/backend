...
export declare const uploadDocument: (req: Request, res: Response, next: import("express").NextFunction) => void;
...
export declare const listCustomers: (req: Request, res: Response, next: import("express").NextFunction) => void;
...
export declare const getCustomerOrders: (req: Request, res: Response, next: import("express").NextFunction) => void;
